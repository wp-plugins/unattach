...
As of WordPress 3.5, the only way to detach a media item from a post is to delete either the post or the media item. This plugin solves that adding a 'Unattach' link below each media file in the Media Library admin view.
